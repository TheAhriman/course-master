...
<body>
               ...
               <form action="" class="course-form">
                <h1>Создание нового урока</h1>
                 <div class="create-content-form">
                    <label for="create_input">Название урока*</label>
                    <input type="text" id="create_input" class="create-input">
                 </div>
                 <div class="create-content-form">
                    <label for="create_input">Описание урока*</label>
                    <textarea name="" id="" cols="30" rows="10"></textarea>
                 </div>
                 <div class="select-res">
                    <select id="select">
                      <option value="">Выберите опцию</option>
                      <option value="block1">Изображение</option>
                      <option value="block2">Видео</option>
                      <option value="block3">Текст</option>
                    </select>
                    ...
                    <div class="block" id="block3">
                      <textarea name="" id="" cols="30" rows="10" class="drop-textarea"></textarea>
                    </div>
                   </div>
                 <button type="submit">Создать</button>
               </form>
               <!-- <div class="course-form-text">Без уроков курс не может существовать!</div> -->
          </div>
        </section>
    </div>
    <footer class="footer">
    ...
    <script src="../js/components/select-bar.js"></script>
