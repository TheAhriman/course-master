...
<head>
    ...
    @vite(['resources/css/zero-down.css', 'resources/css/course-detailes.css','resources/css/side-bar-menu.css','resources/js/burger-button.js','resources/css/course-quiz-form.css','resources/js/drop-down-exite.js'])
...
<header class="header">
    <div class="header-container">
        <div class="main-title">
            ...
            <h1 class="title-page">Проверка пройденного материала</h1>
        </div>
...
<div class="main-content">
    ...
    <div class="block-quiz">
        ...
        <form class="form-quiz">
            <h1 class="title-quiz-form">Кто вы?</h1>
            <div class="forms-answer">
                <div class="quiz-answer">
                    <input type="radio" id="answer-1" name="rad">
                    <label for="answer-1">Я человек желающий жить мирной жизнью</label>
                </div>
                <div class="quiz-answer">
                    <input type="radio" id="answer-2" name="rad">
                    <label for="answer-2">Я панк и рву всё на своём пути</label>
                </div>
                <div class="quiz-answer">
                    <input type="radio" id="answer-3" name="rad">
                    <label for="answer-3">Я хочу покушать</label>
                </div>
                <div class="quiz-answer">
                    <input type="radio" id="answer-4" name="rad">
        ...
        <form class="form-quiz">
            ...
            <div class="forms-answer">
                <div class="quiz-answer">
                    ...
                    <label for="answer-1">RTX 3060Ti</label>
                </div>
                <div class="quiz-answer">
                    <input type="checkbox" id="answer-2">
                    <label for="answer-2">RTX 4090Ti</label>
                </div>
                <div class="quiz-answer">
                    <input type="checkbox" id="answer-3" >
                    <label for="answer-3">GTX 1060ti</label>
                </div>
                <div class="quiz-answer">
                    <input type="checkbox" id="answer-4">
                    <label for="answer-4">GTX 1660 Super</label>
                </div>
            </div>
            <div class="btn-container">
                <button class="button-send">Отправить</button>
