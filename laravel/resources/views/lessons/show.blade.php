...
<head>
    ...
    @vite(['resources/css/zero-down.css', 'resources/css/course-details.css','resources/css/side-bar-menu.css'])
...
<body>
    <header class="header">
        <div class="header-container">
            <div class="main-title">
                <h1 class="title-page">{{$lesson->title}}</h1>
            </div>
    ...
    <div class="step-side-bar-menu">
        <div>
            <a href="{{route('courses.index')}}" class="link-home">&#9668; back</a>
        </div>
        <div class="lessons-links">
            ...
            <ul class="lessons-links-list">
                @foreach($lesson->course->lessons as $course_lesson)
                    <li><i class='bx bxs-bookmark-star'></i><a href="{{route('lessons.show',$course_lesson)}}">{{$course_lesson->title}}</a></li>
                @endforeach
            </ul>
        </div>
    </div>
    <div class="main-content">
        <div class="main-content-container">
            @foreach($lessonContent as $content)
                @if($content->media_type->value == 'text')
                    <div class="text-container">
                        <p class="text-container-content">
                            {!! $content->value !!}
                        </p>
                    </div>
                @endif
                @if($content->media_type->value == 'video')
                        <video controls>
