...
<head>
    ...
    @vite(['resources/css/zero-down.css', 'resources/css/course-index.css','resources/css/side-bar-menu.css','resources/js/coments.js','resources/js/coments.js'])
...
{{--            <h1 class="title-page">Name Course</h1>--}}
{{--        </div>--}}
