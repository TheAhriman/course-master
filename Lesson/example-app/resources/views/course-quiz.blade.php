...
<head>
    ...
    @vite(['resources/css/zero-down.css','resources/css/course-quiz.css','resources/css/side-bar-menu.css','resources/js/burger-button.js','resources/css/course-quiz-form.css','resources/js/drop-down-exite.js'])
