...
<head>
    ...
    @vite('resources/css/page-all-course.css')
        ...
        <section class="main">
            <div class="main-content">
                ...
                <div class="all-courses">
                    ...
                    <div class="course">
                        <a href="file:///C:/Users/user/Desktop/Course%20Master/pages/course-constructor.html">
                            <div class="title">
                                <a href="#" class="title-course">Frontend</a><span> ID: 234113</span>
                            </div>
                            <div class="options-course">
                                <a href="file:///C:/Users/user/Desktop/Course%20Master/pages/course-content.html">Содержание</a>
                                <a href="#">Описание</a>
                                <a href="#">Удалить</a>
                            </div>
                        </a>
                ...
                <div class="create-block">
                    <a href="file:///C:/Users/user/Desktop/Course%20Master/pages/course-constructor.html" class="link-create">Создать курс</a>
                </div>
            </div>
        </section>
    </div>
