...
<head>
    ...
    @vite(['resources/css/zero-down.css','resources/css/my-courses-statistics.css','resources/css/side-bar-menu.css','resources/js/burger-button.js','resources/js/drop-down-exite.js'])
