...
<head>
    ...
    @vite(['resources/css/zero-down.css', 'resources/css/notifications.css','resources/css/side-bar-menu.css','resources/js/burger-button.js','resources/js/drop-down-exite.js','resources/css/notification-block.css','resources/js/drop-notification-block.js'])
...
<header class="header">
    <div class="header-container">
        <div class="main-title">
            ...
            <h1 class="title-page">Уведомления</h1>
            <div class="nav-links">
                <a href="#">Главная</a><span>/</span><a href="{{route('notifications')}}">Уведомления</a>
            </div>
        </div>
            ...
            <div class="incoming-notification">
                <div class="notification-title">
                    <div class="author-notification">
                        <img src="{{ asset('storage/images/images-notification/image-profile.svg')}}" alt="" class="notification-img">
                    </div>
