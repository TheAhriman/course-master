...
<header class="header">
    <div class="header_container">
        <div class="header_nav_menu">
            ...
            <a href="{{route('courses.index')}}" class="header_link">Каталог</a>
            <a href="" class="header_link">Мои курсы</a>
            <a href="" class="header_link">Уведомления</a>
            <a href="{{route('chats.index')}}" class="header_link">Обсуждения</a>
        </div>
...
<div class="main-content">
    <div class="main-content-container">
        ...
        <div class="category-link-more-block">
            <a href="" class="category-link-more">Больше категорий</a>
        </div>
       <div class="main-content-new">
           ...
           <div class="main-content-new-block-content">
               ...
               <div class="card-course-step">
                   ...
                   <a href="" class="card-course-slogans">
