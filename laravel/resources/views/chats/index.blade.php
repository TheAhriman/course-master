...
<head>
    ...
    @vite(['resources/css/zero-down.css', 'resources/css/courses-chats.css','resources/css/side-bar-menu.css','resources/js/burger-button.js','resources/js/drop-down-exite.js','resources/css/notification-block.css','resources/js/drop-notification-block.js'])
...
<header class="header">
    <div class="header-container">
        <div class="main-title">
            ...
            <div class="nav-links">
                <a href="#">Главная</a><span>/</span><a href="">Обсуждения</a>
            </div>
        </div>
            ...
            <div class="notification-block">
                <div class="notification-block-content">
                    ...
                    <div class="link-notifications-block">
                        <a href="" class="link-notifications">Все уведомления</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="main-content">
    <div class="main-content-container">
       <div class="search-discussion-block">
        ...
        <a href="{{route('chats.show',1)}}" class="incoming-discussion">
            <div class="discussion-title">
                ...
                <div class="author-discussion-content">
                    ...
                    <div class="discussion-author-content"><span>Количество сообщений:</span><span>1</span></div>
                </div>
            </div>
        </a>
        <a href="#" class="incoming-discussion">
            <div class="discussion-title">
                ...
                <div class="author-discussion-content">
                    ...
                    <div class="discussion-author-content"><span>Количество сообщений:</span><span>0</span></div>
                </div>
            </div>
        </a>
   </div>
