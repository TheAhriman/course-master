...
<head>
    ...
    @vite(['resources/css/zero-down.css', 'resources/css/course-detailes.css','resources/css/side-bar-menu.css','resources/js/burger-button.js'])
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    <title>Courses-detailes</title>
</head>
    ...
    <header class="header">
        <div class="header-container">
            <div class="main-title">
                ...
                <h1 class="title-page">Fundamentals of Electronic</h1>
                <div class="nav-links">
                    <a href="#">Главная</a><span>/</span><a href="{{route('my-courses-progress')}}">Профиль</a><span>/</span><a href="{{route('courses-catalog')}}">Мои курсы</a><span>/</span><a href="{{route('course-detailes')}}">Курс</a>
                </div>
            </div>
    ...
    <div class="nav-menu">
        <div class="nav-menu-container">
            ...
            <div class="nav-buttons">
                ...
                <a href="{{route('my-courses-statistics')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
    ...
    <div class="step-side-bar-menu">
        ...
        <div class="lessons-links">
            ...
            <ul class="lessons-links-list">
                <li><i class='bx bxs-bookmark-star'></i><a href="#">Basic boards</a></li>
                <li><i class='bx bxs-bookmark-star'></i><a href="#">PCB boards</a></li>
                <li><i class='bx bxs-add-to-queue'></i><a href="#">Quiz 1</a></li>
    ...
    <div class="main-content">
        <div class="main-content-container">
            <div class="text-container">
                <h1 class="text-container-title">PCB boards</h1>
                <p>
                    A printed circuit board (PCB; also printed wiring board or PWB) is a medium used in electrical and
                    electronic engineering to connect electronic components to one another in a controlled manner. It
                    takes the form of a laminated sandwich structure of conductive and insulating layers: each of the
                    conductive layers is designed with an artwork pattern of traces, planes and other features (similar
                    to wires on a flat surface) etched from one or more sheet layers of copper laminated onto and/or
            ...
            <div class="text-container">
                <h1 class="text-container-title">Schematic</h1>
                <p>
                ...
                <p>
                    The components include a footprint (AKA land pattern), i.e., a collection of through-holes and/or
                    surface-mount pads that match the terminal geometry of the physical part. A footprint can also have
                    lines, shapes, and text that are collectively referred to as the silkscreen. These show up on the
                    PCB as purely visual elements; they’re not conductive and do not affect the functionality of the
                    circuit.
                </p>
                <p>
                    The components include a footprint (AKA land pattern), i.e., a collection of through-holes and/or
                ...
                <div class="block-img">
                    <img src="{{ asset('storage/images/shema.svg')}}">
                </div>
            </div>
        <div class="text-container">
            <h1 class="text-container-title">Video</h1>
            <p>
                A schematic consists primarily of components and wires connected in such a way as to produce the
                desired electrical behavior. The wires will become traces or copper pours.
            </p>
            <p>
                The components include a footprint (AKA land pattern), i.e., a collection of through-holes and/or surface-mount pads that match the terminal geometry of the physical part. A footprint can also have lines, shapes, and text that are collectively referred to as the silkscreen. These show up on the PCB as purely visual elements; they’re not conductive and do not affect the functionality of the circuit. The components include a footprint (AKA land pattern), i.e., a collection of through-holes and/or surface-mount pads that match the terminal geometry of the physical part. A footprint can also have lines, shapes, and text that are collectively referred to as the silkscreen. These show up on the PCB as purely visual elements; they’re not conductive and do not affect the functionality of the circuit.
            </p>
            <div class="block-video-container">
                <video  class="block-video" src="{{ asset('storage/video/video.mp4')}}" class="video-source" type="video/mp4" controls></video>
            </div>
        </div>
                <div class="actions-block">
                    <button type="#" class="button-main-container-back">BACK</button>
                    <button type="#" class="button-main-container-end">COMPLETED</button>
