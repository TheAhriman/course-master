...
<head>
    ...
    @vite(['resources/css/zero-down.css','resources/css/favourites.css','resources/css/side-bar-menu.css','resources/js/burger-button.js','resources/css/card-course-style.css','resources/js/drop-down-exite.js','resources/css/notification-block.css','resources/js/drop-notification-block.js'])
...
<header class="header">
    <div class="header-container">
        <div class="main-title">
            ...
            <div class="nav-links">
                <a href="{{route('index')}}">Главная</a><span>/</span><a href="{{route('courses')}}">Мои курсы</a><span>/</span><a href="{{route('favourites')}}">Избранное</a>
            </div>
        </div>
