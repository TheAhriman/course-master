...
<div class="main-content">
    <div class="main-content-container">
        ...
        <div class="categoty-block">
            <a href="#" class="category-block-link">Заявки</a>
            <a href="#" class="category-block-link">Результаты</a>
            <a href="#" class="category-block-link">Ответы</a>
        </div>
                ...
                <div class="notification-content">
                    <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="4" viewBox="0 0 17 4" fill="none">
                            <path d="M2.01745 4C1.46265 4 0.987877 3.804 0.59313 3.412C0.19771 3.02067 0 2.55 0 2C0 1.45 0.19771 0.979 0.59313 0.587C0.987877 0.195667 1.46265 0 2.01745 0C2.57225 0 3.04702 0.195667 3.44177 0.587C3.83719 0.979 4.0349 1.45 4.0349 2C4.0349 2.55 3.83719 3.02067 3.44177 3.412C3.04702 3.804 2.57225 4 2.01745 4ZM8.06979 4C7.51499 4 7.04022 3.804 6.64547 3.412C6.25005 3.02067 6.05234 2.55 6.05234 2C6.05234 1.45 6.25005 0.979 6.64547 0.587C7.04022 0.195667 7.51499 0 8.06979 0C8.62459 0 9.0997 0.195667 9.49512 0.587C9.88987 0.979 10.0872 1.45 10.0872 2C10.0872 2.55 9.88987 3.02067 9.49512 3.412C9.0997 3.804 8.62459 4 8.06979 4ZM14.1221 4C13.5673 4 13.0922 3.804 12.6968 3.412C12.3021 3.02067 12.1047 2.55 12.1047 2C12.1047 1.45 12.3021 0.979 12.6968 0.587C13.0922 0.195667 13.5673 0 14.1221 0C14.6769 0 15.152 0.195667 15.5475 0.587C15.9422 0.979 16.1396 1.45 16.1396 2C16.1396 2.55 15.9422 3.02067 15.5475 3.412C15.152 3.804 14.6769 4 14.1221 4Z" fill="#333333"/>
                        </svg>
                    </a>
                </div>
            </div>
