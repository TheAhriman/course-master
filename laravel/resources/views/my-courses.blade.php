...
<head>
    ...
    @vite(['resources/css/zero-down.css', 'resources/css/my-courses.css','resources/css/side-bar-menu.css'])
                    ...
                    <div class="cards-dashbord">
                        <div class="card-overview">
                            <div class="card-overview-title">
                                <img src="{{ asset('storage/images/icon-learn.svg')}}">
                        ...
                        <div class="card-overview">
                            <div class="card-overview-title">
                                <img src="{{ asset('storage/images/icon-idea.svg')}}">
                                <p>Courses in progress</p>
                            </div>
                            <div class="card-overview-content">
                                <span>7</span>
                        ...
                        <div class="card-overview">
                            <div class="card-overview-title">
                                <img src="{{ asset('storage/images/icon-clock.svg')}}">
                                <p>Courses in progress</p>
                            </div>
                            <div class="card-overview-content">
                                <span>3h 15m</span>
                        ...
                        <div class="card-overview">
                            <div class="card-overview-title">
                                <img src="{{ asset('storage/images/icon-start.svg')}}">
                                <p>Courses in progress</p>
                            </div>
                            <div class="card-overview-content">
                                <span>240</span>
