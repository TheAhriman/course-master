...
<head>
    ...
    @vite(['resources/css/zero-down.css','resources/css/side-bar-menu.css','resources/css/my-course-progress.css','resources/css/card-course-style.css','resources/js/burger-button.js','resources/js/drop-down-exite.js','resources/css/notification-block.css','resources/js/drop-notification-block.js'])
    ...
    <header class="header">
        <div class="header-container">
            <div class="main-title">
                ...
                <div class="nav-links">
                    <a href="{{route('index')}}">Главная</a><span>/</span><a href="{{route('my-courses-progress')}}">Профиль</a>
                </div>
            </div>
                ...
                <div class="enrolled-courses">
                    ...
                    <div class="enrolled-courses-container">
                        ...
                        <div class="enrolled-cours">
                            ...
                            <div class="enrolled-cours-buttons">
                                <div class="enrolled-cours-buttons-progress">
                                    <a href="#" class="link-compled">Окончен</a>
                                    <div class="enrolled-cours-buttons-more">
                                        <a href="#">
                                            <i class='bx bx-x'></i>
                                        </a>
