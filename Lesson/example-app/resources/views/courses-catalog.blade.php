...
<head>
    ...
    @vite(['resources/css/zero-down.css', 'resources/css/course-catalog.css','resources/css/side-bar-menu.css','resources/css/card-course-style.css','resources/js/burger-button.js'])
                    ...
                    <div class="card-course">
                        <div class="top-content">
                            <div class="top-content-title">
                                <a href="{{route('course-index')}}" class="top-content-link">Machine Learning</a>
                            </div>
                            <div class="top-content-text">
                                <a href="{{route('course-index')}}"  class="top-content-text-link">Basic data-structure and algorithm</a>
                            </div>
                        ...
                        <div class="bottom-content">
                            <div class="bottom-content-title">
                                <a href="{{route('course-index')}}"  class="bottom-content-title-link">Machine Learning and Data analysis</a>
                            </div>
                            <div class="bottom-content-date">
                                <div class="bottom-content-autor_block">
                                    <img src="{{ asset('storage/images/copyright.svg')}}" alt="">
                                    <a href="{{route('course-index')}}"  class="bottom-content-autor-link">Shams Tabrez</a>
                                </div>
