...
<head>
    ...
    @vite(['resources/css/zero-down.css','resources/css/my-courses-statistics.css','resources/css/side-bar-menu.css','resources/js/burger-button.js','resources/js/drop-down-exite.js','resources/js/drop-down-exite.js','resources/css/notification-block.css','resources/js/drop-notification-block.js'])
    <title>Statistick</title>
</head>
...
<body>
    <header class="header">
        <div class="header-container">
            <div class="main-title">
                ...
                <h1 class="title-page">Статистика курсов</h1>
                <div class="nav-links">
                    <a href="#">Главная</a><span>/</span><a href="{{route('courses')}}">Мои курсы</a><span>/</span><a href="{{route('my-courses-statistics')}}">Статистика</a>
                </div>
            </div>
    ...
    <div class="main-content" >
        <div class="main-content-container">
            <div class="main-content-container-charts">
                <div class="overview">
                    <h1>OVERVIEW</h1>
                    <div class="cards-dashbord">
                        <div class="card-overview">
                            <div class="card-overview-title">
                                <img src="{{ asset('storage/images/icon-learn.svg')}}" alt="">
                        ...
                        <div class="card-overview">
                            <div class="card-overview-title">
                                <img src="{{ asset('storage/images/icon-idea.svg')}}" alt="" >
                                <p>Courses in progress</p>
                            </div>
                            <div class="card-overview-content">
                                <span>7</span>
                        ...
                        <div class="card-overview">
                            <div class="card-overview-title">
                                <img src="{{ asset('storage/images/icon-clock.svg')}}" alt="">
                                <p>Courses in progress</p>
                            </div>
                            <div class="card-overview-content">
                                <span>3h 15m</span>
                        ...
                        <div class="card-overview">
                            <div class="card-overview-title">
                                <img src="{{ asset('storage/images/icon-start.svg')}}" alt="">
                                <p>Courses in progress</p>
                            </div>
                            <div class="card-overview-content">
                                <span>240</span>
                ...
                <div class="block-statistics">
                    <div class="study-statistics">
                        <div class="header-study-statistics">
                            <h1>STUDY STATISTICS</h1>
                            <div class="study-statistics-time">
                                <div class="week"> week</div>
                                <div class="month"> month</div>
                            </div>
                        </div>
                        <div class="progres-block">
                            <div class="progres-block-day">
                                <div> <img src="{{ asset('storage/images/Rectangle 32.svg')}}" alt=""></div>
                            ...
                            <div class="progres-block-day">
                                <div> <img src="{{ asset('storage/images/Rectangle 32.svg')}}"></div>
                    ...
                    <div class="block-pie-chart">
                        <h1 class="pie-chart-title">PROGRESS</h1>
                        <div class="pie-chart-content">
                            <img src="{{ asset('storage/images/circle.svg')}}">
                        </div>
                        <div class="caption">
                            <div class="about-courses-caption">
                                <img src="{{ asset('storage/images/caption-courses.svg')}}">
                                <p>Courses</p>
                            </div>
                            <div class="about-prototypes-caption">
                                <img src="{{ asset('storage/images/caption-prototypes.svg')}}">
                                <p>Prototypes</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="my-courses-pie-charts">
                    <h1>MY COURSES</h1>
                    <div class="my-courses-pie-charts-container">

                        <div class="course-pie-charts">
                            <div class="course-pie-charts-header">
                                <img src="{{ asset('storage/images/hat.svg')}}">
                                <img src="{{ asset('storage/images/more_horiz.svg')}}">
                            </div>
                            <div class="course-pie-charts-text">
                                <p class="course-pie-charts-name">Introduction to Web Devep...</p>
                                <div class="course-pie-charts-autor">
                                    <img src="{{ asset('storage/images/copyright.svg')}}">
                                    <p class="name-autor">Shams Tabrez</p>
                                </div>
                            </div>
                            <div class="course-pie-charts-content">
                                <img src="{{ asset('storage/images/violet.svg')}}">
                            </div>
                        </div>

                        <div class="course-pie-charts-2">
                            <div class="course-pie-charts-header">
                                <img src="{{ asset('storage/images/hat.svg')}}">
                                <img src="{{ asset('storage/images/more_horiz.svg')}}">
                            </div>
                            ...
                            <div class="course-pie-charts-content">
                                <img src="{{ asset('storage/images/blue.svg')}}">
                            </div>
                        </div>

                        <div class="course-pie-charts-3">
                            <div class="course-pie-charts-header">
                                <img src="{{ asset('storage/images/hat.svg')}}">
                                <img src="{{ asset('storage/images/more_horiz.svg')}}">
                            </div>
                            ...
                            <div class="course-pie-charts-content">
                                <img src="{{ asset('storage/images/white-blue.svg')}}">
                            </div>
                        </div>
            ...
            <div class="main-content-container-live-events">
                <h1>LIVE EVENTS</h1>
                <div class="live-events-block">
                    <div class="live-events-block-img">
                        <img src="{{ asset('storage/images/small-logo.svg')}}">
                    </div>
                    <div class="live-events-block-title">
                        <p class="live-events-block-title-text">Ipsum odio et integer aliquet lorem a, sem suscipit varius.</p>
                        <div class="course-pie-charts-autor">
                            <img src="{{ asset('storage/images/copyright.svg')}}">
                            <p class="name-autor">Shams Tabrez</p>
                        </div>
                    ...
                    <div class="live-block">
                        <img src="{{ asset('storage/images/wi-fi.svg')}}">
                        <p class="live-block-text">Live</p>
                    </div>
                </div>
            </div>
        </div>
